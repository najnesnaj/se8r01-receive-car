                                      ...
                                      4 ; This file was generated Mon Feb  5 14:29:43 2018
                                      5 ;--------------------------------------------------------
      ...
      0080DE 6B 01            [ 1]  253 	ld	(0x01, sp), a
                                    254 ;	se8r01-receive-car.c: 67: if (reg != NOP && reg != FLUSH_RX && reg != FLUSH_TX)
      ...
      0080F0 27 09            [ 1]  263 	jreq	00102$
                                    264 ;	se8r01-receive-car.c: 68: write_spi (value);
      ...
      00811A 6B 01            [ 1]  299 	ld	(0x01, sp), a
                                    300 ;	se8r01-receive-car.c: 78: if (reg != NOP && reg != FLUSH_RX && reg != FLUSH_TX)
      ...
      00812C 27 0B            [ 1]  309 	jreq	00102$
                                    310 ;	se8r01-receive-car.c: 79: ret = write_spi (NOP);
      ...
      008159 6B 02            [ 1]  345 	ld	(0x02, sp), a
                                    346 ;	se8r01-receive-car.c: 89: for (n = 0; n < len; ++n)
      ...
      008161 24 11            [ 1]  351 	jrnc	00101$
                                    352 ;	se8r01-receive-car.c: 90: write_spi (array[n]);
      ...
      008191 6B 01            [ 1]  390 	ld	(0x01, sp), a
                                    391 ;	se8r01-receive-car.c: 98: for (n = 0; n < len; ++n)
      ...
      008199 24 15            [ 1]  396 	jrnc	00101$
                                    397 ;	se8r01-receive-car.c: 99: array[n] = write_spi (NOP);
      ...
      00822D 81               [ 4]  512 	ret
                                    513 ;	se8r01-receive-car.c: 129: void delay (int time_ms) {
                                    514 ;	-----------------------------------------
                                    515 ;	 function delay
                                    516 ;	-----------------------------------------
      00822E                        517 _delay:
      00822E 52 0A            [ 2]  518 	sub	sp, #10
                                    519 ;	se8r01-receive-car.c: 131: for (x = 0; x < 1036*time_ms; ++x)
      ...
      00825D 2E 17            [ 1]  545 	jrsge	00105$
                                    546 ;	se8r01-receive-car.c: 132: __asm__("nop");
      00825F 9D               [ 1]  547 	nop
                                    548 ;	se8r01-receive-car.c: 131: for (x = 0; x < 1036*time_ms; ++x)
      ...
      008278 81               [ 4]  562 	ret
                                    563 ;	se8r01-receive-car.c: 137: void UARTPrintF (char *message) {
                                    564 ;	-----------------------------------------
                                    565 ;	 function UARTPrintF
                                    566 ;	-----------------------------------------
      008279                        567 _UARTPrintF:
                                    568 ;	se8r01-receive-car.c: 138: char *ch = message;
      008279 16 03            [ 2]  569 	ldw	y, (0x03, sp)
                                    570 ;	se8r01-receive-car.c: 139: while (*ch) {
      00827B                        571 00104$:
      00827B 90 F6            [ 1]  572 	ld	a, (y)
      00827D 4D               [ 1]  573 	tnz	a
      00827E 27 0F            [ 1]  574 	jreq	00107$
                                    575 ;	se8r01-receive-car.c: 140: UART1_DR = (unsigned char) *ch;     //  Put the next character into the data transmission register.
      008280 AE 52 31         [ 2]  576 	ldw	x, #0x5231
      008283 F7               [ 1]  577 	ld	(x), a
                                    578 ;	se8r01-receive-car.c: 141: while ((UART1_SR & SR_TXE) == 0);   //  Wait for transmission to complete.
      008284                        579 00101$:
      008284 AE 52 30         [ 2]  580 	ldw	x, #0x5230
      008287 F6               [ 1]  581 	ld	a, (x)
      008288 48               [ 1]  582 	sll	a
      008289 24 F9            [ 1]  583 	jrnc	00101$
                                    584 ;	se8r01-receive-car.c: 142: ch++;                               //  Grab the next character.
      00828B 90 5C            [ 2]  585 	incw	y
      00828D 20 EC            [ 2]  586 	jra	00104$
      00828F                        587 00107$:
      00828F 81               [ 4]  588 	ret
                                    589 ;	se8r01-receive-car.c: 145: void print_UCHAR_hex (unsigned char buffer) {
                                    590 ;	-----------------------------------------
                                    591 ;	 function print_UCHAR_hex
                                    592 ;	-----------------------------------------
      008290                        593 _print_UCHAR_hex:
      008290 52 0C            [ 2]  594 	sub	sp, #12
                                    595 ;	se8r01-receive-car.c: 148: a = (buffer >> 4);
      ...
      0083A6 F7               [ 1]  814 	ld	(x), a
                                    815 ;	se8r01-receive-car.c: 316: write_spi_buf(iRF_CMD_WRITE_REG|iRF_BANK0_CONFIG,temp, 1);
      ...
      0083B1 5B 04            [ 2]  821 	addw	sp, #4
                                    822 ;	se8r01-receive-car.c: 318: temp[0]=0x32;
      0083B3 1E 06            [ 2]  823 	ldw	x, (0x06, sp)
      0083B5 A6 32            [ 1]  824 	ld	a, #0x32
      0083B7 F7               [ 1]  825 	ld	(x), a
                                    826 ;	se8r01-receive-car.c: 320: write_spi_buf(iRF_CMD_WRITE_REG|iRF_BANK0_RF_CH, temp,1);
      ...
      0083F1 5B 04            [ 2]  864 	addw	sp, #4
                                    865 ;	se8r01-receive-car.c: 332: temp[0]=0x77;
      0083F3 1E 06            [ 2]  866 	ldw	x, (0x06, sp)
      0083F5 A6 77            [ 1]  867 	ld	a, #0x77
      0083F7 F7               [ 1]  868 	ld	(x), a
                                    869 ;	se8r01-receive-car.c: 333: write_spi_buf(iRF_CMD_WRITE_REG|iRF_BANK0_PRE_GURD, temp,1);
      ...
      008416 7F               [ 1]  889 	clr	(x)
                                    890 ;	se8r01-receive-car.c: 338: temp[2]=0x10;
      ...
      0084B3 5B 04            [ 2] 1000 	addw	sp, #4
                                   1001 ;	se8r01-receive-car.c: 369: temp[0]=0x00;
      0084B5 1E 06            [ 2] 1002 	ldw	x, (0x06, sp)
      0084B7 7F               [ 1] 1003 	clr	(x)
                                   1004 ;	se8r01-receive-car.c: 370: write_spi_buf(iRF_CMD_WRITE_REG|iRF_BANK1_DAC_CAL_LOW,temp,1);
      ...
      0084C2 5B 04            [ 2] 1010 	addw	sp, #4
                                   1011 ;	se8r01-receive-car.c: 372: temp[0]=0x7F;
      0084C4 1E 06            [ 2] 1012 	ldw	x, (0x06, sp)
      0084C6 A6 7F            [ 1] 1013 	ld	a, #0x7f
      0084C8 F7               [ 1] 1014 	ld	(x), a
                                   1015 ;	se8r01-receive-car.c: 373: write_spi_buf(iRF_CMD_WRITE_REG|iRF_BANK1_DAC_CAL_HI,temp,1);
      ...
      008561 81               [ 4] 1118 	ret
                                   1119 ;	se8r01-receive-car.c: 412: void SE8R01_Analog_Init()           //SE8R01 初始化
                                   1120 ;	-----------------------------------------
                                   1121 ;	 function SE8R01_Analog_Init
                                   1122 ;	-----------------------------------------
      008562                       1123 _SE8R01_Analog_Init:
      008562 52 15            [ 2] 1124 	sub	sp, #21
                                   1125 ;	se8r01-receive-car.c: 417: gtemp[0]=0x28;
      ...
      00856D F7               [ 1] 1130 	ld	(x), a
                                   1131 ;	se8r01-receive-car.c: 418: gtemp[1]=0x32;
      ...
      008577 F7               [ 1] 1137 	ld	(x), a
                                   1138 ;	se8r01-receive-car.c: 419: gtemp[2]=0x80;
      ...
      008582 F7               [ 1] 1145 	ld	(x), a
                                   1146 ;	se8r01-receive-car.c: 420: gtemp[3]=0x90;
      ...
      00858E F7               [ 1] 1152 	ld	(x), a
                                   1153 ;	se8r01-receive-car.c: 421: gtemp[4]=0x00;
      00858F 1E 14            [ 2] 1154 	ldw	x, (0x14, sp)
      008591 1C 00 04         [ 2] 1155 	addw	x, #0x0004
      008594 7F               [ 1] 1156 	clr	(x)
                                   1157 ;	se8r01-receive-car.c: 422: write_spi_buf(iRF_CMD_WRITE_REG|iRF_BANK0_SETUP_VALUE, gtemp, 5);
      ...
      00859F 5B 04            [ 2] 1163 	addw	sp, #4
                                   1164 ;	se8r01-receive-car.c: 423: delay(2);
      ...
      0085B8 F7               [ 1] 1179 	ld	(x), a
                                   1180 ;	se8r01-receive-car.c: 429: temp[1]=0x01;               
      ...
      0085C2 F7               [ 1] 1186 	ld	(x), a
                                   1187 ;	se8r01-receive-car.c: 430: temp[2]=0x30;               
      ...
      0086D3 5B 04            [ 2] 1381 	addw	sp, #4
                                   1382 ;	se8r01-receive-car.c: 482: rf_switch_bank(iBANK0);
      ...
      0086F5                       1408 00105$:
                                   1409 ;	se8r01-receive-car.c: 495: else if  (SE8R01_DR_1M==1)
      0086F5 CE 00 12         [ 2] 1410 	ldw	x, _SE8R01_DR_1M+0
      0086F8 A3 00 01         [ 2] 1411 	cpw	x, #0x0001
      0086FB 26 07            [ 1] 1412 	jrne	00102$
                                   1413 ;	se8r01-receive-car.c: 496: {  temp[0]=0b01000111;  }     //1MHz,+5dbm
      ...
      008704                       1419 00102$:
                                   1420 ;	se8r01-receive-car.c: 498: {temp[0]=0b01101111;  }     //500K,+5dbm
      008704 96               [ 1] 1421 	ldw	x, sp
      008705 5C               [ 2] 1422 	incw	x
      008706 A6 6F            [ 1] 1423 	ld	a, #0x6f
      008708 F7               [ 1] 1424 	ld	(x), a
      008709                       1425 00106$:
                                   1426 ;	se8r01-receive-car.c: 500: write_spi_buf(iRF_CMD_WRITE_REG|iRF_BANK0_RF_SETUP,temp,1);
      ...
      008713 5B 04            [ 2] 1433 	addw	sp, #4
                                   1434 ;	se8r01-receive-car.c: 501: write_spi_reg(WRITE_REG|iRF_BANK0_EN_AA, 0b00111111);          //enable auto acc on pip 1
      ...
      00871C 5B 02            [ 2] 1438 	addw	sp, #2
                                   1439 ;	se8r01-receive-car.c: 502: write_spi_reg(WRITE_REG|iRF_BANK0_EN_RXADDR, 0b00111111);      //enable pip 1
      ...
      008725 5B 02            [ 2] 1443 	addw	sp, #2
                                   1444 ;	se8r01-receive-car.c: 503: write_spi_reg(WRITE_REG|iRF_BANK0_SETUP_AW, 0x02);  
      ...
      00872E 5B 02            [ 2] 1448 	addw	sp, #2
                                   1449 ;	se8r01-receive-car.c: 504: write_spi_reg(WRITE_REG|iRF_BANK0_RF_CH, 40);
      ...
      008737 5B 02            [ 2] 1453 	addw	sp, #2
                                   1454 ;	se8r01-receive-car.c: 506: write_spi_buf(WRITE_REG + TX_ADDR, ADDRESS0, ADR_WIDTH);    	
      ...
      00874A 85               [ 2] 1463 	popw	x
                                   1464 ;	se8r01-receive-car.c: 507: write_spi_buf(WRITE_REG + RX_ADDR_P0, ADDRESS0, ADR_WIDTH); 
      ...
      008753 5B 04            [ 2] 1469 	addw	sp, #4
                                   1470 ;	se8r01-receive-car.c: 508: write_spi_buf(WRITE_REG + RX_ADDR_P1, ADDRESS1, ADR_WIDTH); 
      ...
      008760 5B 04            [ 2] 1476 	addw	sp, #4
                                   1477 ;	se8r01-receive-car.c: 509: write_spi_buf(WRITE_REG + RX_ADDR_P2, ADDRESS2, 1); 
      ...
      00876D 5B 04            [ 2] 1483 	addw	sp, #4
                                   1484 ;	se8r01-receive-car.c: 510: write_spi_buf(WRITE_REG + RX_ADDR_P3, ADDRESS3, 1); 
      ...
      00877A 5B 04            [ 2] 1490 	addw	sp, #4
                                   1491 ;	se8r01-receive-car.c: 511: write_spi_buf(WRITE_REG + RX_ADDR_P4, ADDRESS4, 1); 
      ...
      008787 5B 04            [ 2] 1497 	addw	sp, #4
                                   1498 ;	se8r01-receive-car.c: 512: write_spi_buf(WRITE_REG + RX_ADDR_P5, ADDRESS5, 1); 
      ...
      008794 5B 04            [ 2] 1504 	addw	sp, #4
                                   1505 ;	se8r01-receive-car.c: 513: write_spi_reg(WRITE_REG + RX_PW_P0, PLOAD_WIDTH); 
      ...
      00879D 5B 02            [ 2] 1509 	addw	sp, #2
                                   1510 ;	se8r01-receive-car.c: 514: write_spi_reg(WRITE_REG|iRF_BANK0_CONFIG, 0x3f); 
      ...
      0087A6 5B 02            [ 2] 1514 	addw	sp, #2
                                   1515 ;	se8r01-receive-car.c: 515: write_spi_reg(WRITE_REG|iRF_BANK0_DYNPD, 0b00111111);          // enable dynamic payload length data
      ...
      0087AF 5B 02            [ 2] 1519 	addw	sp, #2
                                   1520 ;	se8r01-receive-car.c: 516: write_spi_reg(WRITE_REG|iRF_BANK0_FEATURE, 0x07);        // enable dynamic paload lenght; enbale payload with ack enable w_tx_payload_noack
      ...
      0087B8 5B 02            [ 2] 1524 	addw	sp, #2
                                   1525 ;	se8r01-receive-car.c: 517: PC_ODR |= (1 << CE);
      ...
      0087FE 81               [ 4] 1577 	ret
                                   1578 ;	se8r01-receive-car.c: 581: int main () {
                                   1579 ;	-----------------------------------------
                                   1580 ;	 function main
                                   1581 ;	-----------------------------------------
      0087FF                       1582 _main:
      0087FF 52 33            [ 2] 1583 	sub	sp, #51
                                   1584 ;	se8r01-receive-car.c: 583: UCHAR rx_addr_p1[]  = { 0xd2, 0xf0, 0xf0, 0xf0, 0xf0 };
      ...
      00881E E7 04            [ 1] 1603 	ld	(0x0004, x), a
                                   1604 ;	se8r01-receive-car.c: 584: UCHAR tx_addr[]     = { 0xe1, 0xf0, 0xf0, 0xf0, 0xf0 };
      ...
      008840 F7               [ 1] 1624 	ld	(x), a
                                   1625 ;	se8r01-receive-car.c: 589: InitializeSystemClock();
      008841 CD 81 E4         [ 4] 1626 	call	_InitializeSystemClock
                                   1627 ;	se8r01-receive-car.c: 590: InitializeUART();
      008844 CD 82 DC         [ 4] 1628 	call	_InitializeUART
                                   1629 ;	se8r01-receive-car.c: 592: InitializeSPI ();
      008847 CD 81 BC         [ 4] 1630 	call	_InitializeSPI
                                   1631 ;	se8r01-receive-car.c: 594: UARTPrintF("start debug \n\r");
      ...
      008851 5B 02            [ 2] 1635 	addw	sp, #2
                                   1636 ;	se8r01-receive-car.c: 596: memset (tx_payload, 0, sizeof(tx_payload));
      ...
      008861 5B 06            [ 2] 1645 	addw	sp, #6
                                   1646 ;	se8r01-receive-car.c: 599: init_io();                        // Initialize IO port
      008863 CD 83 55         [ 4] 1647 	call	_init_io
                                   1648 ;	se8r01-receive-car.c: 600: write_spi_reg(FLUSH_RX,0); // receive data 
      ...
      00886D 5B 02            [ 2] 1652 	addw	sp, #2
                                   1653 ;	se8r01-receive-car.c: 601: readstatus = read_spi_reg(CONFIG);
      00886F 4B 00            [ 1] 1654 	push	#0x00
      008871 CD 81 0A         [ 4] 1655 	call	_read_spi_reg
      008874 5B 01            [ 2] 1656 	addw	sp, #1
                                   1657 ;	se8r01-receive-car.c: 602: UARTPrintF("config = \n\r");
      ...
      0088BF 5B 02            [ 2] 1706 	addw	sp, #2
                                   1707 ;	se8r01-receive-car.c: 616: while (1) {
      0088C1                       1708 00110$:
                                   1709 ;	se8r01-receive-car.c: 618: if ((PD_IDR & (1 << 3))==0) //input low
      ...
      0088CC                       1715 00170$:
                                   1716 ;	se8r01-receive-car.c: 622: delay(240);
      ...
      0088D3 5B 02            [ 2] 1720 	addw	sp, #2
                                   1721 ;	se8r01-receive-car.c: 623: signal_lv=read_spi_reg(iRF_BANK0_RPD);
      ...
      0088DC C7 00 1A         [ 1] 1725 	ld	_signal_lv+0, a
                                   1726 ;	se8r01-receive-car.c: 624: status = read_spi_reg(STATUS);
      ...
      0088E6 C7 00 1D         [ 1] 1730 	ld	_status+0, a
                                   1731 ;	se8r01-receive-car.c: 626: if(status&STA_MARK_RX)                                                 // if receive data ready (TX_DS) interrupt
      0088E9 72 06 00 1D 02   [ 2] 1732 	btjt	_status+0, #6, 00171$
      0088EE 20 57            [ 2] 1733 	jra	00103$
      0088F0                       1734 00171$:
                                   1735 ;	se8r01-receive-car.c: 629: pip= (status & 0b00001110)>>1;
      ...
      0088F8 CF 00 1B         [ 2] 1741 	ldw	_pip+0, x
                                   1742 ;	se8r01-receive-car.c: 630: pload_width_now=read_spi_reg(iRF_CMD_R_RX_PL_WID);
      ...
      008904 CF 00 16         [ 2] 1748 	ldw	_pload_width_now+0, x
                                   1749 ;	se8r01-receive-car.c: 631: read_spi_buf(RD_RX_PLOAD, rx_buf,32);             // read playload to rx_buf
      ...
      008916 5B 04            [ 2] 1757 	addw	sp, #4
                                   1758 ;	se8r01-receive-car.c: 632: write_spi_reg(FLUSH_RX,0);
      ...
      00891F 5B 02            [ 2] 1762 	addw	sp, #2
                                   1763 ;	se8r01-receive-car.c: 634: newdata=1;
      008921 35 01 00 19      [ 1] 1764 	mov	_newdata+1, #0x01
      008925 72 5F 00 18      [ 1] 1765 	clr	_newdata+0
                                   1766 ;	se8r01-receive-car.c: 635: for (teller=0;teller<32;++teller)
      008929 5F               [ 1] 1767 	clrw	x
      00892A                       1768 00112$:
                                   1769 ;	se8r01-receive-car.c: 636: print_UCHAR_hex (rx_buf[teller]);
      ...
      008937 85               [ 2] 1777 	popw	x
                                   1778 ;	se8r01-receive-car.c: 635: for (teller=0;teller<32;++teller)
      008938 5C               [ 2] 1779 	incw	x
      008939 A3 00 20         [ 2] 1780 	cpw	x, #0x0020
      00893C 2F EC            [ 1] 1781 	jrslt	00112$
                                   1782 ;	se8r01-receive-car.c: 637: UARTPrintF("\n\r");
      ...
      008947                       1787 00103$:
                                   1788 ;	se8r01-receive-car.c: 640: write_spi_reg(WRITE_REG+STATUS,status);       // clear RX_DR or TX_DS or MAX_RT interrupt flag
      ...
      008951                       1793 00105$:
                                   1794 ;	se8r01-receive-car.c: 645: for (x1 = 0; x1 < 50; ++x1)
      ...
      00895E                       1802 00173$:
                                   1803 ;	se8r01-receive-car.c: 646: for (y1 = 0; y1 < 50; ++y1)
      ...
      008966 2E 19            [ 1] 1809 	jrsge	00122$
                                   1810 ;	se8r01-receive-car.c: 647: for (z1 = 0; z1 < 50; ++z1)
